...
import {ContactNumberTypeProjection} from '../../models/ContactNumberTypeProjection';
import {ContactNumberTypeProjectionTransformer} from './transformers/ContactNumberTypeProjectionTransformer';
...
/**
 * Responsible for aggregating contact number type details
 */
export class ContactNumberTypeProjectionPipeline implements PipelineInterface {
  getID(): string {
    return 'contact_number_type_event_store';
  }
  ...
  async watch(
    ...
    const projectionTransformer = new ContactNumberTypeProjectionTransformer(opts);
